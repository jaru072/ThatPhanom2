    ...
    if (hasKicker) {
      if (sec.id === "footer") {
        ...
        if (sectionEl.id === "status" || sec.id === "status") {
          ...
          kickerEl = sectionEl.querySelector(".milestone-card-copy time, .milestone-card-copy .kicker, .timeline-head .kicker, .section-heading .kicker, .section-head .kicker, .hero-copy .eyebrow, .kicker, .eyebrow, time, .donation-badge, [data-i18n*='Kicker'], [data-i18n*='kicker']");
        }
        if (kickerEl) {
  ...
  if (sectionEl) {
    ...
    if (secData.kicker === undefined) {
      if (sectionTargetId === "status" || sectionEl.id === "status") {
        ...
        currentKicker = sectionEl.querySelector(".milestone-card-copy time, .milestone-card-copy .kicker, .timeline-head .kicker, .section-heading .kicker, .section-head .kicker, .hero-copy .eyebrow, .kicker, .eyebrow, .hero-kicker, .status-label, time, .feature-no, .criteria-number, .donation-badge")?.textContent || "";
      }
    }
...
_updateAdminDOMState();
_renderSiteSectionsCMS();
document.addEventListener("DOMContentLoaded", () => { _renderSiteSectionsCMS(); });
