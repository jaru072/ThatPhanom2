    ...
    if (hasKicker) {
      if (sec.id === "footer") {
        ...
        if (sectionEl.id === "status" || sec.id === "status") {
          ...
          kickerEl = sectionEl.querySelector(".milestone-card-copy time, .milestone-card-copy .kicker, .timeline-head .kicker, .section-heading .kicker, .section-head .kicker, .hero-copy .eyebrow, .kicker, .eyebrow, time");
        }
        if (kickerEl) {
    ...
    if (hasContent) {
      if (sec.id === "footer") {
        ...
        if (sectionEl.id === "muchalinda-history" || sectionEl.classList.contains("muchalinda-overview-media") || sectionEl.classList.contains("milestones-overview-media")) {
          ...
          descEl = sectionEl.querySelector(".milestone-card-copy span, .milestone-card-copy p, .process-step-copy span, .process-step-copy p, .criteria-card-copy p, .story-feature-copy p, .story-mini-copy p, .hero-copy p.lead, p.lead, .section-description, span[data-i18n*='Text'], p[data-i18n*='Text'], p[data-i18n*='Intro'], p[data-i18n*='Desc']");
          if (!descEl) {
...
function _openSectionEditor(sectionTargetId) {
  ...
  if (sectionEl) {
    if (secData.title === undefined || !currentTitle) {
      if (sectionTargetId === "status" || sectionEl.id === "status") {
    ...
    if (secData.kicker === undefined || !currentKicker) {
      if (sectionTargetId === "status" || sectionEl.id === "status") {
    ...
    if (secData.content === undefined || !currentContent) {
      if (sectionTargetId === "status" || sectionEl.id === "status") {
